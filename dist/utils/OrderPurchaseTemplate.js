...
exports.OrderPurchaseTemplate = void 0;
const OrderPurchaseTemplate = (data) => __awaiter(void 0, void 0, void 0, function* () {
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" style="font-size:14px;border:2px solid #ebe5eb;border-radius:0.6rem;padding:15px;margin-bottom:10px">
                      <tbody><tr style="vertical-align:top">
                          <td style="text-align:justify">
                              ...
                              <b style="color:#510839">Correo:</b> <a href="mailto:${data.emailProvider}" target="_blank">${data.emailProvider}</a>
...
exports.OrderPurchaseTemplate = OrderPurchaseTemplate;
//# sourceMappingURL=OrderPurchaseTemplate.js.map